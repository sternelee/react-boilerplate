! function (e) {
        ...
        if (!L.silentResource && !t.message) {
            ...
            if (r.src !== e.location.href && (!r.src || !r.src.match(/.*\/(.*)$/) || r.src.match(/.*\/(.*)$/)[1]) && a.target.src && e.XMLHttpRequest) {
                ...
                i.Fundebug = !0, i.open("HEAD", a.target.src), i.send(), i.onload = function (e) {
                    200 !== e.target.status && (a.target.status = e.target.status, a.target.statusText = e.target.statusText), h(a)
                }
            }
        }
    }
    ...
    function p(t) {
        ...
        r = t.target ? t.target : t.srcElement;
        var n = r && r.outerHTML;
        n && n.length > 200 && (n = n.slice(0, 200)), f({
            type: "click",
            page: {
                url: e.location.href,
    ...
    function T(t) {
        ...
        if (r) {
            ...
            if (e.XMLHttpRequest && e.atob) {
                ...
                a.Fundebug = !0, a.open("POST", n), a.setRequestHeader("Content-Type", "application/json"), a.send(r)
            } else {
    ...
    var w = !1,
        D = t();
    L.silent = D.getAttribute("silent") || !1, L.maxEventNumber = D.getAttribute("maxEventNumber") || 10, L.silentResource = D.getAttribute("silentResource") || !1, L.silentHttp = D.getAttribute("silentHttp") || !1, L.silentConsole = L.silentConsole || D.getAttribute("silentConsole") || !1, r(e, "onerror", function () {
        ...
        if (H) {
            ...
            a && a.hasOwnProperty && a.hasOwnProperty("addEventListener") && (r(a, "addEventListener", function (e) {
                return function (t, r, a, i) {
                    return r && r.handleEvent && (r.handleEvent = n(r.handleEvent)), e.call(this, t, n(r), a, i)
                }
    ...
    e.onhashchange, e.onhashchange = function () {
        var t = {
            url: e.location.href,
            title: document.title
        };
